...
interface UserProfileMatchComponentState {
  showError: boolean;
  error: string | null;
...
export class UserProfileMatchComponent extends Component<UserProfileMatchComponentState> {
  protected static state: UserProfileMatchComponentState = {
    error: null,
    showError: false,
    friendships: [],
    loading: true,
  ...
  protected onMount(): void {
    console.log('UserProfileMatchComponent onMount called');
  ...
  protected onUnmount(): void {
    console.log('UserProfileMatchComponent onUnmount called');
  ...
  render() {
    if (this.state.error) {
      console.error('UserProfileMatchComponent error:', this.state.error);
    }
